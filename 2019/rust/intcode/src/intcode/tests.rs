...
mod test {
    ...
    fn day05_example_1() {
        // Outputs whatever it gets as input
        {
            ...
            assert_eq!(Result::Output(42), output);
        }
    ...
    fn day09_example_1() {
        {
            ...
            while let Result::Output(out) = computer.run(Vec::new()) {
                outputs.push(out);
            }
        ...
        }
        {
            ...
            let mut computer = Intcode::new(&program);
            assert_eq!(
                Result::Output(1_219_070_632_396_864),
                computer.run(Vec::new())
            )
        }
        {
            ...
            let mut computer = Intcode::new(&program);
            assert_eq!(
                Result::Output(1_125_899_906_842_624),
                computer.run(Vec::new())
            )
        }
    }
